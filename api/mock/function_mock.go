...
func (m *MockFunctionService) GetFunctionLogs(appID, functionID string) (api.FunctionLogs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFunctionLogs", appID, functionID)
	ret0, _ := ret[0].(api.FunctionLogs)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetFunctionLogs indicates an expected call of GetFunctionLogs.
func (mr *MockFunctionServiceMockRecorder) GetFunctionLogs(appID, functionID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFunctionLogs", reflect.TypeOf((*MockFunctionService)(nil).GetFunctionLogs), appID, functionID)
}
